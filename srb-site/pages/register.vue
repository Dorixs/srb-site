      ...
      <div class="registerCont">
        <ul>
          ...
          <li class="telNumber">
            ...
            <input class="input" v-model="userInfo.mobile"  placeholder="请输入手机号码"/>
          ...
          <li class="code">
            ...
            <input class="input" v-model="userInfo.code" placeholder="请输入验证码" />
            <!-- <span class="info">
              请输入验证码
            </span> -->
            <button v-if="!sending" class="button" @click="send()">
          ...
          <li>
            ...
            <input type="password" v-model="userInfo.password" class="input" placeholder="请输入密码"/>
            <span class="info">
